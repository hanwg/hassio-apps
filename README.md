...
This app enables you to host your own [Telegram Bot API server](https://github.com/tdlib/telegram-bot-api) instead of using the official Telegram cloud servers at `https://api.telegram.org`.

Hosting your own server offers advantages such as larger file size limits for messages and faster response times.
...
The app is built using the [hanwg/telegram-bot-api](https://github.com/hanwg/telegram-bot-api) image, compiled directly from the [TDLib official source](https://github.com/tdlib/telegram-bot-api).
...
Check the [documentation](https://github.com/hanwg/hassio-apps/blob/main/telegram-bot-api/DOCS.md) for comprehensive setup guides and other resources.
